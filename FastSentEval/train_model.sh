#Part of Felix Hill's SentenceRepresentation codebase
#https://github.com/fh295/SentenceRepresentation.git
...
#***********************#
#The change that needed to be made to work with Anaconda python. You will
#have to change it accordingly to compile it
#***********************#

#gcc -shared -pthread -fPIC -fwrapv -O2 -Wall -fno-strict-aliasing -I/usr/include/python2.7 -o fastsent_inner.so fastsent_inner.c
gcc -shared -pthread -fPIC -fwrapv -O2 -Wall -fno-strict-aliasing -I/home/agentjay/anaconda3/envs/python2/lib/python2.7/site-packages/numpy/core/include -I/home/agentjay/anaconda3/envs/python2/include/python2.7 -o fastsent_inner.so fastsent_inner.c
...
python trainFastSent.py --corpus ../raw_data/books_in_sentences/books_large_70m.txt  --dim 300 
